...
// ******************************************************************************************************
  ...
  function gotData(data) {
    ...
    console.log(the23Cards[7]);
    console.log(the23Cards[8]);
  ...
  console.log(the23Cards[7], the23Cards[8]);
...
// not sure if the next part is needed at all
  ...
  console.log('cards needed 7: ' + the23Cards[7]);
  console.log('cards needed 8: ' + the23Cards[8]);

  card1 = the23Cards[7].toString();
  card2 = the23Cards[8].toString();
