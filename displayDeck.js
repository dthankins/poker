...
function preload() {
  ...
  for(i=0;i<namesArray.length;i++){
    ...
    //imagesArray[i].resize(90,124);

    imagesArray[i].resize(45,0);
...
/*
  ...
  */
  ...
  for(i=0;i<myNewDeck.length;i++){

    var cardString = myNewDeck[i].toString();
    var myCardIndex = namesArray.indexOf(cardString);
    var myImageInfo = imagesArray[myCardIndex];
    myImageInfo.resize(60,0);
    var myImage = image(myImageInfo,myImageX, myImageY);
    //myImage.resize(60,0);
    myImageX+=65;
    var myModulo = i % 13;
    console.log('myModulo: ' + myModulo);
    if(myModulo === 0 && i != 0){
      console.log('we should add 90 to Y');
      myImageY+=90;
      myImageX=0;
    }
  ...
  image(imagesArray[card1Index],110,450);
  image(imagesArray[card2Index],210,450);

  image(imagesArray[player2Card1Index],410,450);
  image(imagesArray[player2Card2Index],510,450);
